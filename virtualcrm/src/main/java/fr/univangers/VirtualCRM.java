...
/**
 * Classe principale de l'application VirtualCRM.
 */
...
public class VirtualCRM {
    ...
    public static void main(String[] args) throws IOException, TException {
         ...
         * 
         * //sTest.addLead("Pierre,Tournesol",300000, "0712345697","3 rue Jean Zay",
         * "82000", "Paris", "France", "Google", "Ile-de-France");
        ...
        /*
         * VirtualCRMServiceImpl virtualCRMService =
         * VirtualCRMServiceFactory.getInstance();
         * 
         * int id = virtualCRMService.addLead("test,test",50000, "070896545", "rertet",
         * "49460", "aaaaa", "france", "oui", "hehe");
         * 
         * /*
